...
export function FileWorkspace({
  ...
  const defaultRootTab = useMemo(() => {
    return designSystemProject
      ? DESIGN_SYSTEM_TAB
      : (pageFiles[0]?.name ?? DESIGN_FILES_TAB);
  }, [designSystemProject, pageFiles]);
  ...
  return (
    ...
    >
      ...
      <div className="ws-tabs-shell">
        ...
        >
          {/* Design system tab hidden in AI-first mode */}
      ...
      <div className="ws-body">
        ...
        {activeTab === DESIGN_SYSTEM_TAB && designSystemProject ? (
          ...
          <div className="viewer-empty">Loading project...</div>
        ) : isBrowserTabId(activeTab) ? (
          null
